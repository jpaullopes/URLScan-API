from src.obfuscation import obfuscation_function_verificator

# Exemplo de uso

# Caso 1: URL suspeita
url_maliciosa = "http://pagamento-seguro.com@site-estranho.net/login"
resultado1 = obfuscation_function_verificator(url_maliciosa)
print(f"Analisando '{url_maliciosa}': {resultado1}") # Vai imprimir True

# Caso 2: URL normal
url_legitima = "https://www.google.com"
resultado2 = obfuscation_function_verificator(url_legitima)
